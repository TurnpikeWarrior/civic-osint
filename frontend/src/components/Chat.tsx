    ...
    <div className={containerClasses} role="region" aria-label="AI Intelligence Terminal">
      <div className="bg-blue-700 py-3.5 px-5 text-white flex justify-between items-center shadow-lg relative z-10">
        ...
        <div className="flex items-center gap-1">
          {messages.length > 0 && (
            <button
              onClick={() => { setMessages([]); setActionTrigger(null); }}
              className="text-white/80 hover:text-white transition-all duration-300 outline-none p-1 cursor-pointer"
              aria-label="Clear chat"
              title="Clear chat"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>
            </button>
          )}
          {mode === 'floating' && (
            <button
