  ...
  return (
    <div className="h-screen bg-white flex flex-col font-sans selection:bg-blue-100 overflow-hidden text-black">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 flex items-center justify-center p-6 relative bg-gray-50/30 overflow-y-auto">
          {/* Background Visuals */}
          ...
          <div className="z-10 w-full max-w-2xl flex flex-col items-center justify-center py-12">
            {/* Subtle Welcome Tag */}
      ...
      <footer className="py-4 text-center bg-white border-t border-gray-100 z-10">
