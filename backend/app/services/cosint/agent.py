...
def get_cosint_agent(streaming: bool = False):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "Contextual Hint: {context}\n\n"
                   ...
                   "- ACTION TRIGGER (MEMBER): If you have identified a specific representative the user is asking about, append this tag at the very end: [CREATE_PAGE_ACTION: Member Name | BIOGUIDE_ID]\n"
