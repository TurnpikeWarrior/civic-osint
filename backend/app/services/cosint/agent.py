...
def get_cosint_agent(streaming: bool = False):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "Contextual Hint: {context}\n\n"
                   ...
                   "- ACTION TRIGGER (MEMBER): If you have identified a specific representative the user is asking about, append this tag: [CREATE_PAGE_ACTION: Member Name | BIOGUIDE_ID]\n"
                   "- ACTION TRIGGER (BILL): If you have identified a specific bill the user is researching, append this tag: [RESEARCH_BILL: Congress | Type | Number]\n"
